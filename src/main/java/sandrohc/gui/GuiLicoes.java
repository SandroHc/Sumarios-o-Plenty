...
public class GuiLicoes extends javax.swing.JDialog {
    ...
    /**
     * Converte a lista de lições atual numa array de short numa string com quetras de linha a cada nova posição do array
     * @return
     */
    ...
    /**
     * Converte a string de lições atual (do TextArea) numa array de shorts para poder ser armazenada na variável licoes da classe Sumario
     *
     * @return uma array de shorts com a nova lista de lições
     */
    private short[] strToShort() {
        ...
        for (int i = 0; i < texto.length; i++) {
            try {
                if (texto[i].isEmpty()) // Faz com que linhas vazias sejam ignoradas
                    continue;
